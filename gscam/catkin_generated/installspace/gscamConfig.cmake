...
if("FALSE" STREQUAL "TRUE")
  set(gscam_SOURCE_PREFIX /home/chris/robot_vision_ws/src/gscam)
  set(gscam_DEVEL_PREFIX /home/chris/robot_vision_ws/src/devel)
...
if(NOT "include;/usr/include/gstreamer-0.10;/usr/include/glib-2.0;/usr/lib/x86_64-linux-gnu/glib-2.0/include;/usr/include/libxml2 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gscam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  Ask the maintainer 'Jonathan Bohren <jbo@jhu.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /usr/local/lib;/home/chris/robot_vision_ws/devel/lib;/opt/ros/indigo/lib)
